package com.singuloid.singuloidappstore.lib.view;
 ...
 *
 * The implementation of the ExpandableTextView are Ctrl+C from the github, great thanks
 * for @author Manabu-GT
 *
 */
