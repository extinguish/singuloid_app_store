 ...
 */
public class STabStrip extends LinearLayout {
    ...
    private STabIndicatorInterpolator indicationInterpolator;
    private STabLayout.TabColorizer customTabColorizer;

    STabStrip(Context context, AttributeSet attrs) {
        super(context);
        ...
        int indicationInterpolatorId = STabIndicatorInterpolator.ID_SMART;
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.STabLayout);
        indicatorAlwaysInCenter = a.getBoolean(
                R.styleable.STabLayout_indicatorAlwaysInCenter, indicatorAlwaysInCenter);
        indicatorInFront = a.getBoolean(
                R.styleable.STabLayout_indicatorInFront, indicatorInFront);
        indicationInterpolatorId = a.getInt(
                R.styleable.STabLayout_indicatorInterpolation, indicationInterpolatorId);
        indicatorColor = a.getColor(
                R.styleable.STabLayout_indicatorColor, indicatorColor);
        indicatorColorsId = a.getResourceId(
                R.styleable.STabLayout_indicatorColors, indicatorColorsId);
        indicatorThickness = a.getDimensionPixelSize(
                R.styleable.STabLayout_indicatorThickness, indicatorThickness);
        indicatorCornerRadius = a.getDimension(
                R.styleable.STabLayout_indicatorCornerRadius, indicatorCornerRadius);
        underlineColor = a.getColor(
                R.styleable.STabLayout_underlineColor, underlineColor);
        underlineThickness = a.getDimensionPixelSize(
                R.styleable.STabLayout_underlineThickness, underlineThickness);
        dividerColor = a.getColor(
                R.styleable.STabLayout_dividerColor, dividerColor);
        dividerColorsId = a.getResourceId(
                R.styleable.STabLayout_dividerColors, dividerColorsId);
        dividerThickness = a.getDimensionPixelSize(
                R.styleable.STabLayout_dividerThickness, dividerThickness);
        a.recycle();
        ...
        this.indicationInterpolator = STabIndicatorInterpolator.of(indicationInterpolatorId);
    }
    ...
    void setIndicationInterpolator(STabIndicatorInterpolator interpolator) {
        indicationInterpolator = interpolator;
        invalidate();
    }

    void setCustomTabColorizer(STabLayout.TabColorizer customTabColorizer) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final STabLayout.TabColorizer tabColorizer = (customTabColorizer != null)
                ? customTabColorizer
                : defaultTabColorizer;
    ...
    private static class SimpleTabColorizer implements STabLayout.TabColorizer {
