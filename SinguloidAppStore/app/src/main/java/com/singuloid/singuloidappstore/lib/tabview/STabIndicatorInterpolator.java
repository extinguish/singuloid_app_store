 ...
 */
public abstract class STabIndicatorInterpolator {

    public static final STabIndicatorInterpolator SMART = new SmartIndicationInterpolator();
    public static final STabIndicatorInterpolator LINEAR = new LinearIndicationInterpolator();

    static final int ID_SMART = 0;
    static final int ID_LINEAR = 1;

    public static STabIndicatorInterpolator of(int id) {
        switch (id) {
            case ID_SMART:
                return SMART;
            case ID_LINEAR:
    ...
    public static class SmartIndicationInterpolator extends STabIndicatorInterpolator {
    ...
    public static class LinearIndicationInterpolator extends STabIndicatorInterpolator {
